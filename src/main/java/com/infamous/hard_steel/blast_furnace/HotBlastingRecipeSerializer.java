...
public class HotBlastingRecipeSerializer<T extends HotBlastingRecipe> extends net.minecraftforge.registries.ForgeRegistryEntry<IRecipeSerializer<?>> implements IRecipeSerializer<T> {

    private final int cookingTime;
    private final HotBlastingRecipeSerializer.IFactory<T> iBlastRecipeFactory;

    public HotBlastingRecipeSerializer(HotBlastingRecipeSerializer.IFactory<T> factoryIn, int cookingTimeIn) {
    ...
    public interface IFactory<T extends HotBlastingRecipe> {
