...
public class AnvilBlockv2 extends AnvilBlock {
  ...
  public INamedContainerProvider getContainer(BlockState blockState, World world, BlockPos blockPos) {
    return new SimpleNamedContainerProvider((windowId, playerInventory, p_220272_4_) -> {
      return new ForgingContainer(windowId, playerInventory, IWorldPosCallable.of(world, blockPos));
    }, new TranslationTextComponent("Forge & Name"));
  }
  ...
  //  return new AnvilTile(AnvilRegistryEvents.ANVIL_TILE_ENTITY);
  //}
}
