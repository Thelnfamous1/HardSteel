...
public class ArmorNetheriteChainmail extends ArmorItem
{
	...
	public ArmorNetheriteChainmail(IArmorMaterial materialIn, EquipmentSlotType slots, Properties builder)
	{
	...
	{
		return repair.getItem() == ItemList.netherite_chain;
	}
