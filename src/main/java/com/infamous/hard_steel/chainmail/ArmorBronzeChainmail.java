...
public class ArmorBronzeChainmail extends ArmorItem
{
	...
	public ArmorBronzeChainmail(IArmorMaterial materialIn, EquipmentSlotType slots, Properties builder)
	{
	...
	{
		return repair.getItem() == ItemList.bronze_chain;
	}
