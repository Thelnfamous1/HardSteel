...
public class ArmorMithrilChainmail extends ArmorItem
{
	private static double fullyArmoredMovementSpeedPenalty = EquipmentUtilities.getDefaultMovementSpeed() * 0.0625 * -1;
	private static double fullyArmoredKnockbackResistanceBenefit = 0.0625;

	public ArmorMithrilChainmail(IArmorMaterial materialIn, EquipmentSlotType slots, Properties builder)
	{
	...
	{
		return repair.getItem() == ItemList.mithril_chain;
	}
