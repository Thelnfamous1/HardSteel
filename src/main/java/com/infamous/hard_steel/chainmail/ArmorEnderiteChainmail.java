...
public class ArmorEnderiteChainmail extends ArmorItem
{
	...
	public ArmorEnderiteChainmail(IArmorMaterial materialIn, EquipmentSlotType slots, Properties builder)
	{
	...
	{
		return repair.getItem() == ItemList.enderite_chain;
	}
