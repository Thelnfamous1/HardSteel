...
public class ArmorCopperChainmail extends ArmorItem
{
	...
	public ArmorCopperChainmail(IArmorMaterial materialIn, EquipmentSlotType slots, Properties builder)
	{
	...
	{
		return repair.getItem() == ItemList.copper_chain;
	}
