...
public class ArmorIronChainmail extends ArmorItem
{
	...
	public ArmorIronChainmail(IArmorMaterial materialIn, EquipmentSlotType slots, Properties builder)
	{
	...
	{
		return repair.getItem() == ItemList.iron_chain;
	}
