package com.infamous.hard_steel.items.mithril;
...
public class ArmorMithril extends ArmorItem
{
	...
	public ArmorMithril(IArmorMaterial materialIn, EquipmentSlotType slots, Properties builder)
	{
	...
	{
		return repair.getItem() == ItemList.mithril_ingot;
	}
