package com.infamous.hard_steel.items.netherite;
...
public class ArmorNetherite extends ArmorItem
{
	private static double fullyArmoredMovementSpeedPenalty = EquipmentUtilities.getDefaultMovementSpeed() * 0.25 * -1;
	private static double fullyArmoredKnockbackResistanceBenefit = 0.25;

	public ArmorNetherite(IArmorMaterial materialIn, EquipmentSlotType slots, Properties builder)
	{
	...
	{
		return repair.getItem() == ItemList.netherite_ingot;
	}
