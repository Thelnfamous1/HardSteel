package com.infamous.hard_steel.items.iron;
...
public class ArmorIron extends ArmorItem
{
	...
	public ArmorIron(IArmorMaterial materialIn, EquipmentSlotType slots, Properties builder)
	{
