...
public class FineryForgeScreen extends ContainerScreen<FineryForgeContainer> {
    private static final ResourceLocation GUI_TEXTURE = new ResourceLocation("hard_steel:textures/gui/container/finery_forge.png");

    public FineryForgeScreen(FineryForgeContainer screenContainer, PlayerInventory inv, ITextComponent titleIn) {
