...
/**
 *
 * SmithingTableUpdateEvent is fired when a player places items in both the left and right slots of a smithing table.
 ...
 */
@Cancelable
public class SmithingTableUpdateEvent extends Event
{
    @Nonnull
    ...
    public SmithingTableUpdateEvent(@Nonnull ItemStack left, @Nonnull ItemStack right, String name, int cost)
    {
        this.left = left;
        this.right = right;
