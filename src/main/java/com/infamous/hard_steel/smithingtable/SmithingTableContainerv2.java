...
public class SmithingTableContainerv2 extends Container {
    ...
    //public SmithingTableTileEntity tileEntity;
    public int materialCost;
    String repairedItemName;
    private final PlayerEntity player;
    private final BlockPos pos;

    public SmithingTableContainerv2(int windowId, World world, BlockPos readBlockPos, PlayerInventory inv, PlayerEntity player) {
        ...
        //tileEntity = (SmithingTableTileEntity) world.getTileEntity(readBlockPos);
        /**
        this.addSlot(new SlotItemHandler(tileEntity.handler, 0, 27, 47){
            @Override
            public void onSlotChanged() {
                HardSteel.logger.info("Input slot ran onSlotChanged! Stack is " + (this.getStack().isEmpty() ? "Empty" : "Not Empty"));
        ...
        **/
        ...
        this.addSlot(new Slot(this.outputSlot, 2, 134, 47) {
            ...
            public boolean canTakeStack(PlayerEntity playerIn) {
                return (playerIn.abilities.isCreativeMode || playerIn.experienceLevel >= SmithingTableContainerv2.this.maximumCost.get()) && SmithingTableContainerv2.this.maximumCost.get() > 0 && this.getHasStack();
            }

            @Override
            public ItemStack onTake(PlayerEntity thePlayer, ItemStack stack) {
                if (!thePlayer.abilities.isCreativeMode) {
                    thePlayer.addExperienceLevel(-SmithingTableContainerv2.this.maximumCost.get());
                }
                ...
                SmithingTableContainerv2.this.inputSlots.setInventorySlotContents(0, ItemStack.EMPTY);
                if (SmithingTableContainerv2.this.materialCost > 0) {
                    //ItemStack itemstack = tileEntity.handler.getStackInSlot(1);
                    ItemStack itemstack = SmithingTableContainerv2.this.inputSlots.getStackInSlot(1);

                    if (!itemstack.isEmpty() && itemstack.getCount() > SmithingTableContainerv2.this.materialCost) {
                        itemstack.shrink(SmithingTableContainerv2.this.materialCost);
                        //tileEntity.handler.setStackInSlot(1, itemstack);
                        SmithingTableContainerv2.this.inputSlots.setInventorySlotContents(1, itemstack);
                    } else {
                        //tileEntity.handler.setStackInSlot(1, ItemStack.EMPTY);
                        SmithingTableContainerv2.this.inputSlots.setInventorySlotContents(1, ItemStack.EMPTY);
                    }
                } else {
                    //tileEntity.handler.setStackInSlot(1, ItemStack.EMPTY);
                    SmithingTableContainerv2.this.inputSlots.setInventorySlotContents(1, ItemStack.EMPTY);
                ...
                SmithingTableContainerv2.this.maximumCost.set(0);
    ...
    public boolean canInteractWith(PlayerEntity playerIn) {
        return  //world.getBlockState(pos).isIn(BlockTags.ANVIL) &&
                playerIn.getDistanceSq(pos.getX() + 0.5D,
    ...
    public static boolean onSmithingTableChange(SmithingTableContainerv2 container, @Nonnull ItemStack left, @Nonnull ItemStack right, IInventory outputSlot, String name, int baseCost)
    {
