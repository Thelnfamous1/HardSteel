...
public class BloomingRecipeSerializer<T extends BloomingRecipe> extends net.minecraftforge.registries.ForgeRegistryEntry<IRecipeSerializer<?>> implements IRecipeSerializer<T> {

    private final int cookingTime;
    private final BloomingRecipeSerializer.IFactory<T> iBlastRecipeFactory;

    public BloomingRecipeSerializer(BloomingRecipeSerializer.IFactory<T> factoryIn, int cookingTimeIn) {
    ...
    public interface IFactory<T extends BloomingRecipe> {
